...
public class DashboardSIswa extends javax.swing.JFrame {
    ...
    public void tabelTrans() {
        String[] judul = {"No Transaksi","ID Petugas","NISN","Tanggal","Bulan Dibayar","Tahun","ID SPP","Jumlah Dibayar"};
    ...
    private void initComponents() {
        ...
        tNama_user.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 110, -1, 50));
