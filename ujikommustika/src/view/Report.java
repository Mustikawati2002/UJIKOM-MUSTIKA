...
DefaultTableModel model6, model7;
    ...
    private void initComponents() {
        ...
        rep_sis1 = new javax.swing.JTable();
        ...
        getContentPane().add(rep_cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 180, 130, -1));

        rep_sis1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        rep_sis1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                rep_sis1MouseReleased(evt);
            }
        });
        jScrollPane4.setViewportView(rep_sis1);

        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 200, 510, 170));
    ...
    private void rep_sis1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rep_sis1MouseReleased
        // TODO add your handling code here:
        repSis_mouse();

    }//GEN-LAST:event_rep_sis1MouseReleased
    ...
    private javax.swing.JTable rep_sis1;
    ...
    private void repTrans_tampil() {
        ...
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/mustika_db", "root", "");
